...
const GensetManagement = () => {
  ...
  const fetchGensets = async () => {
    try {
      setLoading(true);
      const response = await api.get('/gensets');
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredGensets.length > 0 ? (
          filteredGensets.map((genset) => (
            <div key={genset._id} className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
              ...
              <div className="space-y-2 mb-4 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">${genset.price}</span>
                </div>
                <div className="flex justify-between">
