              ...
              {filteredServices.map((service) => (
                <tr key={service._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">
                    {service.customerId?.name || service.customerId?.email || 'N/A'}
                  </td>
            ...
            <div className="space-y-4 mb-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {selectedService.customerId?.name || selectedService.customerId?.email || 'N/A'}
                  </p>
                </div>
                <div>
              ...
              {selectedService.contactNumber && (
                <div>
                  ...
                  <p className="text-gray-800">{selectedService.contactNumber}</p>
                </div>
              )}
